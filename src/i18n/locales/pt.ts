...
export const pt = {
  ...
  history: {
    ...
    genAtaNoAiSub: 'Extrai participantes, duração e os trechos mais centrais — sem interpretar decisões/pendências',
    noAiSummaryTitle: 'Resumo automático (sem IA)',
    noAiSummaryDisclaimer: 'Gerado por código determinístico (TextRank) — não interpreta decisões, pendências ou bloqueios; só destaca os trechos mais centrais da conversa.',
    ...
    noAiSummaryExcerpts: 'Principais trechos',
