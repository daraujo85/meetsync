...
export const es: Messages = {
  ...
  history: {
    ...
    genAtaNoAiSub: 'Extrae participantes, duración y los fragmentos más centrales — no interpreta decisiones/pendientes',
    noAiSummaryTitle: 'Resumen automático (sin IA)',
    noAiSummaryDisclaimer: 'Generado por código determinístico (TextRank) — no interpreta decisiones, pendientes ni bloqueos; solo destaca los fragmentos más centrales de la conversación.',
    ...
    noAiSummaryExcerpts: 'Fragmentos principales',
