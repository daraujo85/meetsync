...
export const en: Messages = {
  ...
  history: {
    ...
    genAtaNoAiSub: 'Extracts participants, duration and the most central excerpts — does not interpret decisions/pending items',
    noAiSummaryTitle: 'Automatic summary (no AI)',
    noAiSummaryDisclaimer: 'Generated by deterministic code (TextRank) — does not interpret decisions, pending items or blockers; just highlights the most central excerpts of the conversation.',
    ...
    noAiSummaryExcerpts: 'Key excerpts',
